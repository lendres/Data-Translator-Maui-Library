...
public abstract class FlatFileInputProcessor : InputProcessor
{
	...
	public override void Close()
	{
		...
		{
			throw new NullReferenceException("The input stream has not been initialized.");
		}
	...
	protected void FindLineByStartString(string lineBeginning)
	{
		...
		if (_inputReport == null)
		{
			throw new NullReferenceException("The input report is null.");
		}

		string? line = _inputStream.ReadLine();
		_inputReport.ReadPreliminaryLine();
		
		while (line != null && !line.Trim().StartsWith(lineBeginning, StringComparison.CurrentCultureIgnoreCase))
		{
